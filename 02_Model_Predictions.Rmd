...
model.mlr <- lm(dietaryMCPD~. 
                # + alcohol:DHPMA_a
                # + DHPMA_a:HEIGHT
                # + DHPMA_a:CREATININE # Not significant!
                + DHPMA_a:HBP
                + DHPMA_a:MARRIAGE, data = train_data)
summary(model.mlr)
...
model.gam <- gam(dietaryMCPD~CREATININE+HEIGHT+BMI+age
                             + s(BEANOILintake, bs="cr") + s(PEANUTOIintake, bs="cr") + s(LARDOILintake, bs="cr") 
                             + s(MET, bs="cr") + s(DHPMA_a, bs="cr") + s(totalenergy, bs="cr")
